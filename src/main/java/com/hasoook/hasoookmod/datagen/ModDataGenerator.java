...
public class ModDataGenerator {
    ...
    public static void register(GatherDataEvent event) {
        ...
        TagsProvider<Block> tagsprovider4 = generator.addProvider(event.includeServer(),new ModBlockTagsProvider(output,lookupProvider,HasoookMod.MOD_ID,existingFileHelper));
        generator.addProvider(event.includeServer(),new ModItemTagsProvider(output,lookupProvider,tagsprovider4.contentsGetter(),HasoookMod.MOD_ID,existingFileHelper));
